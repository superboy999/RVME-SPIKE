...
struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return mr_name[insn.md()];
  }
} md;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return mr_name[insn.ms1()];
  }
} ms1;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return mr_name[insn.ms2()];
  }
} ms2;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return mr_name[insn.ms3()];
  }
} ms3;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return std::to_string((int)insn.uimm10());
  }
} uimm10;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return std::to_string((int)insn.mode());
  }
} mode;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return std::to_string((int)insn.uimm5());
  }
} uimm5;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return std::to_string((int)insn.uimm3());
  }
} uimm3;

struct : public arg_t {
  std::string to_string(insn_t insn) const {
    return std::to_string((int)insn.lut_type());
  }
} lut_type;
...
void disassembler_t::add_instructions(const isa_parser_t* isa, bool strict)
{
  ...
  if (isa->extension_enabled(EXT_MATRIX)){
    add_insn(new disasm_insn_t("msettilem", match_msettilem, mask_msettilem, {&xrs1}));
    add_insn(new disasm_insn_t("msettilemi", match_msettilemi, mask_msettilemi, {&uimm10}));
    add_insn(new disasm_insn_t("msettilek", match_msettilek, mask_msettilek, {&xrs1}));
    add_insn(new disasm_insn_t("msettileki", match_msettileki, mask_msettileki, {&uimm10}));
    add_insn(new disasm_insn_t("msettilen", match_msettilen, mask_msettilen, {&xrs1}));
    add_insn(new disasm_insn_t("msettileni", match_msettileni, mask_msettileni, {&uimm10}));
    add_insn(new disasm_insn_t("mmacc.w.b", match_mmacc_w_b, mask_mmacc_w_b, {&ms1, &ms2, &md}));
    // add_insn(new disasm_insn_t("mmaccu.w.b", match_mmaccu_w_b, mask_mmaccu_w_b, {&ms1, &ms2, &md}));
    // add_insn(new disasm_insn_t("mmaccus.w.b", match_mmaccus_w_b, mask_mmaccus_w_b, {&ms1, &ms2, &md}));
    // add_insn(new disasm_insn_t("mmaccsu.w.b", match_mmaccsu_w_b, mask_mmaccsu_w_b, {&ms1, &ms2, &md}));
    
    // // ===== Load/Store 到/从 DRAM ↔ SPM / A/B/C 通道（若你的编码需要 setid，可把最后一位改成 &setid）=====
    add_insn(new disasm_insn_t("mlae8",   match_mlae8,   mask_mlae8,   {&md, &xrs1, &xrs2}));
    add_insn(new disasm_insn_t("mlbe8",   match_mlbe8,   mask_mlbe8,   {&md, &ms1, &ms2}));
    add_insn(new disasm_insn_t("mlce32",  match_mlce32,  mask_mlce32,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msae8",   match_msae8,   mask_msae8,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msbe8",   match_msbe8,   mask_msbe8,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msce32",  match_msce32,  mask_msce32,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mlate8",  match_mlate8,  mask_mlate8,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mlbte8",  match_mlbte8,  mask_mlbte8,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mlcte32", match_mlcte32, mask_mlcte32, {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msate8",  match_msate8,  mask_msate8,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msbte8",  match_msbte8,  mask_msbte8,  {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mscte32", match_mscte32, mask_mscte32, {&md, &ms1, &ms2}));
    add_insn(new disasm_insn_t("mlae8_spm",   match_mlae8_spm,   mask_mlae8_spm,   {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("mlbe8_spm",   match_mlbe8_spm,   mask_mlbe8_spm,   {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("mlce32_spm",  match_mlce32_spm,  mask_mlce32_spm,  {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("mlcte32_spm", match_mlcte32_spm, mask_mlcte32_spm, {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("msae8_spm",   match_msae8_spm,   mask_msae8_spm,   {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("msbe8_spm",   match_msbe8_spm,   mask_msbe8_spm,   {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("msce32_spm",  match_msce32_spm,  mask_msce32_spm,  {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("mscte32_spm", match_mscte32_spm, mask_mscte32_spm, {&md, &xrs1, &xrs2, &mode}));
    add_insn(new disasm_insn_t("load_spm",   match_load_spm,   mask_load_spm,   {&xrs1, &xrs2, &uimm5}));
    add_insn(new disasm_insn_t("store_spm",  match_store_spm,  mask_store_spm,  {&xrs1, &xrs2, &uimm5}));
    add_insn(new disasm_insn_t("msync_spm", match_msync_spm, mask_msync_spm, {}));
    // ===== 矩阵与通用寄存器搬移 =====
    add_insn(new disasm_insn_t("mmov_mm",   match_mmov_mm,   mask_mmov_mm,   {&md, &ms1}));
    // add_insn(new disasm_insn_t("mmovb_x_m", match_mmovb_x_m, mask_mmovb_x_m, {&md, &ms1}));
    // add_insn(new disasm_insn_t("mmovw_x_m", match_mmovw_x_m, mask_mmovw_x_m, {&md, &ms1}));
    // add_insn(new disasm_insn_t("mmovb_m_x", match_mmovb_m_x, mask_mmovb_m_x, {&md, &ms1}));
    // add_insn(new disasm_insn_t("mmovw_m_x", match_mmovw_m_x, mask_mmovw_m_x, {&md, &ms1}));
    // ===== 标量-矩阵算术（_mm 三寄存器 / _mv_i 立即数）=====
    add_insn(new disasm_insn_t("madd_w_mm",   match_madd_w_mm,   mask_madd_w_mm,   {&md, &ms1, &ms2}));
    add_insn(new disasm_insn_t("madd_w_mv_i", match_madd_w_mv_i, mask_madd_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    // add_insn(new disasm_insn_t("msub_w_mm",   match_msub_w_mm,   mask_msub_w_mm,   {&md, &ms1, &ms2}));
    add_insn(new disasm_insn_t("msub_w_mv_i", match_msub_w_mv_i, mask_msub_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("mmul_w_mm",   match_mmul_w_mm,   mask_mmul_w_mm,   {&md, &ms1, &ms2}));
    add_insn(new disasm_insn_t("mmul_w_mv_i", match_mmul_w_mv_i, mask_mmul_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    // add_insn(new disasm_insn_t("mmulh_w_mm",   match_mmulh_w_mm,   mask_mmulh_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mmulh_w_mv_i", match_mmulh_w_mv_i, mask_mmulh_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("mmax_w_mm",   match_mmax_w_mm,   mask_mmax_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mmax_w_mv_i", match_mmax_w_mv_i, mask_mmax_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    // add_insn(new disasm_insn_t("mumax_w_mm",   match_mumax_w_mm,   mask_mumax_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mumax_w_mv_i", match_mumax_w_mv_i, mask_mumax_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("mmin_w_mm",   match_mmin_w_mm,   mask_mmin_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mmin_w_mv_i", match_mmin_w_mv_i, mask_mmin_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    // add_insn(new disasm_insn_t("mumin_w_mm",   match_mumin_w_mm,   mask_mumin_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("mumin_w_mv_i", match_mumin_w_mv_i, mask_mumin_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("msrl_w_mm",   match_msrl_w_mm,   mask_msrl_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msrl_w_mv_i", match_msrl_w_mv_i, mask_msrl_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("msll_w_mm",   match_msll_w_mm,   mask_msll_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msll_w_mv_i", match_msll_w_mv_i, mask_msll_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("msra_w_mm",   match_msra_w_mm,   mask_msra_w_mm,   {&md, &ms1, &ms2}));
    // add_insn(new disasm_insn_t("msra_w_mv_i", match_msra_w_mv_i, mask_msra_w_mv_i, {&md, &ms1, &ms2, &uimm3}));
    add_insn(new disasm_insn_t("mlut_w_i",  match_mlut_w_i,  mask_mlut_w_i,  {&md, &ms1, &uimm3, &lut_type}));
    add_insn(new disasm_insn_t("mredcadd_w", match_mredcadd_w, mask_mredcadd_w, {&md, &ms1}));
    add_insn(new disasm_insn_t("mredcmax_w", match_mredcmax_w, mask_mredcmax_w, {&md, &ms1}));
    add_insn(new disasm_insn_t("mredcadd_w_i", match_mredcadd_w_i, mask_mredcadd_w_i, {&md, &ms1, &uimm3}));
    add_insn(new disasm_insn_t("mredcmax_w_i", match_mredcmax_w_i, mask_mredcmax_w_i, {&md, &ms1, &uimm3}));
