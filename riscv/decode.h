...
public:
  ...
  uint64_t md() { return x(7, 3); }
  uint64_t ms1() { return x(15, 3); }
  uint64_t ms2() { return x(20, 3); }
  uint64_t ms3() { return x(7, 3); }
  uint64_t uimm3() { return x(23, 3); }
  uint64_t uimm10() { return x(15, 10); }
  uint64_t d_size() { return x(10, 2); }
  uint64_t uimm5() { return x(7, 5); }
  uint64_t setid() { return x(28, 2); }
  uint64_t mode() { return x(10, 2); }
  uint64_t lut_type() { return x(20, 3); }
